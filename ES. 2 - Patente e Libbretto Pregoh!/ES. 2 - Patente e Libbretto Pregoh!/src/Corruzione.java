...
public class Corruzione {
    ...
    public static void RivelaPersonaTentatrice() {
        ...
        if(probabilita<=70){
            ...
            StatusDoganiere.aggiungiMazzette();
            }
        else {
    ...
    public static int getMazzetta() {
        return mazzetta;
    }

    public static void setMazzetta(int mazzetta) {
        Corruzione.mazzetta = mazzetta;
    }
}